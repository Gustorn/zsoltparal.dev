...
export type ListLatestPostsQueryVariables = Exact<{ [key: string]: never; }>;


export type ListLatestPostsQuery = (
  { __typename?: 'RootQuery' }
  & { posts?: Maybe<(
    { __typename?: 'RootQueryToPostConnection' }
    & PostListFragment
...
export type GetPostBySlugQuery = (
  ...
  & { post?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'date' | 'title' | 'excerpt' | 'content'>
    & { author?: Maybe<(
      { __typename?: 'NodeWithAuthorToUserConnectionEdge' }
      & { node?: Maybe<(
        { __typename?: 'User' }
      ...
      { __typename?: 'PostTypeSEO' }
      & Pick<PostTypeSeo, 'fullHead'>
    )> }
  )> }
);

export const PostListFragmentDoc = gql`
    fragment PostList on RootQueryToPostConnection {
  nodes {
    title
    author {
      node {
    ...
    `;
export const ListLatestPostsDocument = gql`
    query listLatestPosts {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    listLatestPosts(variables?: ListLatestPostsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<ListLatestPostsQuery> {
      return withWrapper(() => client.request<ListLatestPostsQuery>(ListLatestPostsDocument, variables, requestHeaders));
    },
    listPosts(variables?: ListPostsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<ListPostsQuery> {
      return withWrapper(() => client.request<ListPostsQuery>(ListPostsDocument, variables, requestHeaders));
    },
    getPostBySlug(variables: GetPostBySlugQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetPostBySlugQuery> {
      return withWrapper(() => client.request<GetPostBySlugQuery>(GetPostBySlugDocument, variables, requestHeaders));
    }
  };
}
